...
pub(crate) fn prompt_for_pull_selection(
    ...
    if selected_index == 0 {
        ...
        let confirmed_root_dir =
            prompt_for_output_dir(&format!("Output directory for {}", ALL_TEAMS_OPTION), root_dir);
...
pub(crate) fn prompt_for_merge_all_teams(default_value: bool) -> bool {
...
pub(crate) fn prompt_for_output_dir(label: &str, default_dir: PathBuf) -> PathBuf {
